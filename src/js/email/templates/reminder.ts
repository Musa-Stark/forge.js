import type { ReminderEmailPlaceholders } from "../../types/email/reminder.type.js";
...
const reminderEmail = ({
  ...
  unsubscribeUrl,
  currentYear,
}: ReminderEmailPlaceholders): string => {
  return `<!DOCTYPE html>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;">
      <tr>
        <td width="56" height="56" style="width:56px;height:56px;border-radius:16px;background-color:#FEF3E2;text-align:center;vertical-align:middle;" bgcolor="#FEF3E2">
          <div style="font-size:0;line-height:0;"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#F59E0B" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="9"/><path d="M12 7.2V12l3.2 2.4"/></svg></div>
        </td>
      </tr>
    </table>
            ...
            <p style="margin:0 0 14px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;color:#475569;">Hi ${userName}, just a reminder that <strong>${reminderTitle}</strong> is due on ${reminderDueDate}.</p>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:28px 0 4px 0;">
      <tr>
        <td style="border-radius:10px;background-color:#F59E0B;" bgcolor="#F59E0B">
          <a href="${reminderUrl}" target="_blank"
