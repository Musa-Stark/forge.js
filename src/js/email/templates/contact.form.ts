import type { ContactFormEmailPlaceholders } from "../../types/email/contact.form.type.js";
...
const contactFormEmail = ({
  ...
  unsubscribeUrl,
  currentYear,
}: ContactFormEmailPlaceholders): string => {
  return `<!DOCTYPE html>
...
<title>New contact form submission from ${contactName}</title>
<!--[if mso]>
<noscript>
<xml>
...
<body style="margin:0;padding:0;background-color:#F1F5F9;">
  <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;font-size:1px;line-height:1px;color:#F1F5F9;">
    ${contactName} submitted the contact form.
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;">
      <tr>
        <td width="56" height="56" style="width:56px;height:56px;border-radius:16px;background-color:#E2F2F1;text-align:center;vertical-align:middle;" bgcolor="#E2F2F1">
          <div style="font-size:0;line-height:0;"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#0D9488" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M4 6.5h16v11H4z"/><path d="M4.5 7l7.5 6 7.5-6"/></svg></div>
        </td>
      </tr>
    </table>
            ...
            <p style="margin:0 0 14px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;color:#475569;"><strong>${contactName}</strong> (${contactEmail}) submitted the contact form:</p>
      ...
      <tr>
        <td style="background-color:#E7F4F3;border-left:3px solid #0D9488;border-radius:8px;padding:14px 18px;">
          <table role="presentation" cellpadding="0" cellspacing="0">
            <tr>
              <td style="vertical-align:top;padding-right:10px;padding-top:1px;"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#0D9488" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M4 6.5h16v11H4z"/><path d="M4.5 7l7.5 6 7.5-6"/></svg></td>
              <td style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13.5px;line-height:20px;color:#0F172A;">${formMessage}</td>
            </tr>
          </table>
        </td>
      </tr>
