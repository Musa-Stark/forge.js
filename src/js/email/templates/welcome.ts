import type { WelcomeEmailPlaceholders } from "../../types/email/welcome.type.js";
...
const welcomeEmail = ({
  ...
  unsubscribeUrl,
  currentYear,
}: WelcomeEmailPlaceholders): string => {
  return `<!DOCTYPE html>
...
<title>Welcome to ${companyName}, ${userName}!</title>
<!--[if mso]>
<noscript>
<xml>
...
<body style="margin:0;padding:0;background-color:#F1F5F9;">
  <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;font-size:1px;line-height:1px;color:#F1F5F9;">
    You're in — here's how to get started with ${companyName}.
  ...
  <center style="width:100%;background-color:#F1F5F9;">
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;">
      <tr>
        <td width="56" height="56" style="width:56px;height:56px;border-radius:16px;background-color:#E2F4FC;text-align:center;vertical-align:middle;" bgcolor="#E2F4FC">
          <div style="font-size:0;line-height:0;"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#0EA5E9" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M4 11l8-7 8 7"/><path d="M6 9.8V20h12V9.8"/></svg></div>
        </td>
      </tr>
    </table>
            ...
            <p style="margin:0 0 14px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;color:#475569;">We're glad you're here. Your ${companyName} account is ready to go, and you can start exploring right away.</p><p style="margin:0 0 14px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;color:#475569;">Here's a quick way to get moving:</p>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:28px 0 4px 0;">
      <tr>
        <td style="border-radius:10px;background-color:#0EA5E9;" bgcolor="#0EA5E9">
          <a href="${dashboardUrl}" target="_blank"
            ...
            <p style="margin:20px 0 0 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13px;line-height:20px;color:#94A3B8;">Questions along the way? Just reply to this email or reach us at ${supportEmail}.</p>
