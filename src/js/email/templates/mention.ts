import type { MentionEmailPlaceholders } from "../../types/email/mention.type.js";
...
const mentionEmail = ({
  ...
  unsubscribeUrl,
  currentYear,
}: MentionEmailPlaceholders): string => {
  return `<!DOCTYPE html>
...
<title>${mentionAuthor} mentioned you</title>
<!--[if mso]>
<noscript>
<xml>
...
<body style="margin:0;padding:0;background-color:#F1F5F9;">
  <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;font-size:1px;line-height:1px;color:#F1F5F9;">
    ${mentionAuthor} mentioned you in ${contextTitle}.
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;">
      <tr>
        <td width="56" height="56" style="width:56px;height:56px;border-radius:16px;background-color:#FEF3E2;text-align:center;vertical-align:middle;" bgcolor="#FEF3E2">
          <div style="font-size:0;line-height:0;"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#F59E0B" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="4"/><path d="M16 12v1.3a2.5 2.5 0 005 0V12a9 9 0 10-3.8 7.3"/></svg></div>
        </td>
      </tr>
    </table>
            ...
            <p style="margin:0 0 14px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;color:#475569;"><strong>${mentionAuthor}</strong> mentioned you in <strong>${contextTitle}</strong>:</p>
      ...
      <tr>
        <td style="background-color:#FEF5E7;border-left:3px solid #F59E0B;border-radius:8px;padding:14px 18px;">
          <table role="presentation" cellpadding="0" cellspacing="0">
            <tr>
              <td style="vertical-align:top;padding-right:10px;padding-top:1px;"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#F59E0B" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="4"/><path d="M16 12v1.3a2.5 2.5 0 005 0V12a9 9 0 10-3.8 7.3"/></svg></td>
              <td style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13.5px;line-height:20px;color:#0F172A;">${mentionText}</td>
            </tr>
          </table>
        </td>
      </tr>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:28px 0 4px 0;">
      <tr>
        <td style="border-radius:10px;background-color:#F59E0B;" bgcolor="#F59E0B">
          <a href="${mentionUrl}" target="_blank"
