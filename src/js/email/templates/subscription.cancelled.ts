import type { SubscriptionCancelledEmailPlaceholders } from "../../types/email/subscription.cancelled.type.js";
...
const subscriptionCancelledEmail = ({
  ...
  unsubscribeUrl,
  currentYear,
}: SubscriptionCancelledEmailPlaceholders): string => {
  return `<!DOCTYPE html>
...
<title>Your ${planName} subscription was cancelled</title>
<!--[if mso]>
<noscript>
<xml>
...
<body style="margin:0;padding:0;background-color:#F1F5F9;">
  <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;font-size:1px;line-height:1px;color:#F1F5F9;">
    Your subscription will end on ${cancellationDate}.
  ...
  <center style="width:100%;background-color:#F1F5F9;">
    ...
    <div class="email-container" style="max-width:600px;margin:0 auto;">
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
        ...
        <tr><td style="height:4px;line-height:4px;font-size:4px;background-color:#64748B;border-radius:16px 16px 0 0;" bgcolor="#64748B">&nbsp;</td></tr>
        <tr>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;">
      <tr>
        <td width="56" height="56" style="width:56px;height:56px;border-radius:16px;background-color:#ECEEF1;text-align:center;vertical-align:middle;" bgcolor="#ECEEF1">
          <div style="font-size:0;line-height:0;"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#64748B" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="9"/><path d="M9 9l6 6M15 9l-6 6"/></svg></div>
        </td>
      </tr>
    </table>
            ...
            <p style="margin:0 0 14px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;color:#475569;">Hi ${userName}, we're sorry to see you go. Your <strong>${planName}</strong> subscription has been cancelled and will remain active until ${cancellationDate}.</p>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:28px 0 4px 0;">
      <tr>
        <td style="border-radius:10px;background-color:#64748B;" bgcolor="#64748B">
          <a href="${resubscribeUrl}" target="_blank"
            ...
            <p style="margin:20px 0 0 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13px;line-height:20px;color:#94A3B8;">We'd love to hear why — reply to this email or reach ${supportEmail} anytime.</p>
