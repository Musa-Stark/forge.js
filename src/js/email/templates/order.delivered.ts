import type { OrderDeliveredEmailPlaceholders } from "../../types/email/order.delivered.type.js";
...
const orderDeliveredEmail = ({
  ...
  unsubscribeUrl,
  currentYear,
}: OrderDeliveredEmailPlaceholders): string => {
  return `<!DOCTYPE html>
...
<title>Your order was delivered — ${orderNumber}</title>
<!--[if mso]>
<noscript>
<xml>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;">
      <tr>
        <td width="56" height="56" style="width:56px;height:56px;border-radius:16px;background-color:#E3F4E9;text-align:center;vertical-align:middle;" bgcolor="#E3F4E9">
          <div style="font-size:0;line-height:0;"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#16A34A" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M4 11l8-7 8 7"/><path d="M6 9.8V20h12V9.8"/></svg></div>
        </td>
      </tr>
    </table>
            ...
            <p style="margin:0 0 14px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;color:#475569;">Hi ${userName}, order <strong>${orderNumber}</strong> was delivered on ${deliveryDate}. We hope you love it!</p>
      ...
      <tr>
        <td style="border-radius:10px;background-color:#16A34A;" bgcolor="#16A34A">
          <a href="${orderUrl}" target="_blank"
            ...
            <p style="margin:20px 0 0 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13px;line-height:20px;color:#94A3B8;">Something wrong with your order? Let us know and we'll make it right.</p>
