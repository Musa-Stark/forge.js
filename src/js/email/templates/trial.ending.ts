import type { TrialEndingEmailPlaceholders } from "../../types/email/trial.ending.type.js";
...
const trialEndingEmail = ({
  ...
  unsubscribeUrl,
  currentYear,
}: TrialEndingEmailPlaceholders): string => {
  return `<!DOCTYPE html>
...
<title>Your trial ends in ${daysRemaining} days</title>
<!--[if mso]>
<noscript>
<xml>
...
<body style="margin:0;padding:0;background-color:#F1F5F9;">
  <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;font-size:1px;line-height:1px;color:#F1F5F9;">
    Your ${companyName} trial ends on ${trialEndDate}.
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;">
      <tr>
        <td width="56" height="56" style="width:56px;height:56px;border-radius:16px;background-color:#FAEFE1;text-align:center;vertical-align:middle;" bgcolor="#FAEFE1">
          <div style="font-size:0;line-height:0;"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#D97706" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="9"/><path d="M12 7.2V12l3.2 2.4"/></svg></div>
        </td>
      </tr>
    </table>
            ...
            <p style="margin:0 0 14px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;color:#475569;">Hi ${userName}, your free trial of <strong>${planName}</strong> ends on ${trialEndDate} (${daysRemaining} days left).</p><p style="margin:0 0 14px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;color:#475569;">Add a payment method now to keep uninterrupted access.</p>
