import type { MagicLinkEmailPlaceholders } from "../../types/email/magic.link.type.js";
...
const magicLinkEmail = ({
  ...
  unsubscribeUrl,
  currentYear,
}: MagicLinkEmailPlaceholders): string => {
  return `<!DOCTYPE html>
...
<title>Your sign-in link for ${companyName}</title>
<!--[if mso]>
<noscript>
<xml>
...
<body style="margin:0;padding:0;background-color:#F1F5F9;">
  ...
  <center style="width:100%;background-color:#F1F5F9;">
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;">
      <tr>
        <td width="56" height="56" style="width:56px;height:56px;border-radius:16px;background-color:#EAE9FC;text-align:center;vertical-align:middle;" bgcolor="#EAE9FC">
          <div style="font-size:0;line-height:0;"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#4F46E5" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M9.5 14.5l5-5"/><path d="M7 12l-2 2a3.8 3.8 0 005.4 5.4l2-2"/><path d="M17 12l2-2a3.8 3.8 0 00-5.4-5.4l-2 2"/></svg></div>
        </td>
      </tr>
    </table>
            ...
            <p style="margin:0 0 14px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;color:#475569;">Hi ${userName}, click below to sign in to ${companyName} instantly. No password required.</p>
    ...
    <p style="margin:16px 0 0 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13px;line-height:20px;color:#94A3B8;">
      ...
      <span style="color:#475569;word-break:break-all;">${magicLinkUrl}</span>
    </p>
            <p style="margin:20px 0 0 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13px;line-height:20px;color:#94A3B8;">This link expires in ${expiryMinutes} minutes and can only be used once. Didn't request this? You can ignore this email.</p>
