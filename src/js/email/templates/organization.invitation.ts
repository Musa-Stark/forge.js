import type { OrganizationInvitationEmailPlaceholders } from "../../types/email/organization.invitation.type.js";
...
const organizationInvitationEmail = ({
  ...
  unsubscribeUrl,
  currentYear,
}: OrganizationInvitationEmailPlaceholders): string => {
  return `<!DOCTYPE html>
...
<title>You're invited to join ${organizationName} on ${companyName}</title>
<!--[if mso]>
<noscript>
<xml>
...
<body style="margin:0;padding:0;background-color:#F1F5F9;">
  <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;font-size:1px;line-height:1px;color:#F1F5F9;">
    Join ${organizationName} on ${companyName} — accept your invitation.
  ...
  <center style="width:100%;background-color:#F1F5F9;">
      ...
      <tr>
        <td width="56" height="56" style="width:56px;height:56px;border-radius:16px;background-color:#EFE7FD;text-align:center;vertical-align:middle;" bgcolor="#EFE7FD">
          <div style="font-size:0;line-height:0;"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#7C3AED" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><circle cx="9" cy="8.2" r="3"/><path d="M3.2 19.5c0-3 2.6-5.2 5.8-5.2s5.8 2.2 5.8 5.2"/><circle cx="17" cy="9" r="2.3"/><path d="M20.8 19.5c0-2.3-1.7-4.2-4-4.7"/></svg></div>
            ...
            <p style="margin:0 0 14px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;color:#475569;">${inviterName} has invited you to join <strong>${organizationName}</strong> on ${companyName} as a ${memberRole}.</p>
    ...
    <p style="margin:16px 0 0 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13px;line-height:20px;color:#94A3B8;">
      ...
      <span style="color:#475569;word-break:break-all;">${inviteUrl}</span>
            ...
            <p style="margin:20px 0 0 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13px;line-height:20px;color:#94A3B8;">This invitation expires on ${expiryDate}.</p>
