import type { AccountDeletedEmailPlaceholders } from "../../types/email/account.deleted.type.js";
...
const accountDeletedEmail = ({
  ...
  unsubscribeUrl,
  currentYear,
}: AccountDeletedEmailPlaceholders): string => {
  return `<!DOCTYPE html>
...
<body style="margin:0;padding:0;background-color:#F1F5F9;">
  <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;font-size:1px;line-height:1px;color:#F1F5F9;">
    Your ${companyName} account and associated data have been removed.
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;">
      <tr>
        <td width="56" height="56" style="width:56px;height:56px;border-radius:16px;background-color:#E9EBED;text-align:center;vertical-align:middle;" bgcolor="#E9EBED">
          <div style="font-size:0;line-height:0;"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#475569" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M5 7h14"/><path d="M9.5 7V4.3h5V7"/><path d="M7 7l1 13h8l1-13"/></svg></div>
        </td>
      </tr>
    </table>
            ...
            <p style="margin:0 0 14px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;color:#475569;">Hi ${userName}, as requested, your ${companyName} account and associated data were permanently deleted on ${deletionDate}.</p><p style="margin:0 0 14px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;color:#475569;">If this was a mistake or you'd like to come back, we'd love to have you again.</p>
            
            
            
            
            
            <p style="margin:20px 0 0 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13px;line-height:20px;color:#94A3B8;">Didn't request this? Contact ${supportEmail} immediately.</p>
