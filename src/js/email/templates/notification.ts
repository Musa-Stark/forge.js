import type { NotificationEmailPlaceholders } from "../../types/email/notification.type.js";
...
const notificationEmail = ({
  ...
  unsubscribeUrl,
  currentYear,
}: NotificationEmailPlaceholders): string => {
  return `<!DOCTYPE html>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;">
      <tr>
        <td width="56" height="56" style="width:56px;height:56px;border-radius:16px;background-color:#FEF3E2;text-align:center;vertical-align:middle;" bgcolor="#FEF3E2">
          <div style="font-size:0;line-height:0;"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#F59E0B" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M6 10.2a6 6 0 0112 0c0 4.8 1.8 6 1.8 6H4.2s1.8-1.2 1.8-6z"/><path d="M10 19.8a2 2 0 004 0"/></svg></div>
        </td>
      </tr>
    </table>
            ...
            <p style="margin:0 0 14px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;color:#475569;">Hi ${userName}, ${notificationBody}</p>
