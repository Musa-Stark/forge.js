import type { MemberRemovedEmailPlaceholders } from "../../types/email/member.removed.type.js";

const memberRemovedEmail = ({
  memberName,
  teamName,
  companyName,
  companyUrl,
  ...
  unsubscribeUrl,
  currentYear,
}: MemberRemovedEmailPlaceholders): string => {
  return `<!DOCTYPE html>
...
<title>${memberName} was removed from ${teamName}</title>
<!--[if mso]>
<noscript>
<xml>
...
<body style="margin:0;padding:0;background-color:#F1F5F9;">
  <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;font-size:1px;line-height:1px;color:#F1F5F9;">
    A member has been removed from your team on ${companyName}.
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;">
      <tr>
        <td width="56" height="56" style="width:56px;height:56px;border-radius:16px;background-color:#ECEEF1;text-align:center;vertical-align:middle;" bgcolor="#ECEEF1">
          <div style="font-size:0;line-height:0;"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#64748B" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><circle cx="9" cy="8.2" r="3"/><path d="M3.2 19.5c0-3 2.6-5.2 5.8-5.2s5.8 2.2 5.8 5.2"/><circle cx="17" cy="9" r="2.3"/><path d="M20.8 19.5c0-2.3-1.7-4.2-4-4.7"/></svg></div>
        </td>
      </tr>
    </table>
            ...
            <p style="margin:0 0 14px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;color:#475569;">Hi ${userName}, <strong>${memberName}</strong> was removed from <strong>${teamName}</strong> by ${actorName} on ${changeDate}.</p>
