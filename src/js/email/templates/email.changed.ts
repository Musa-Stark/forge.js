import type { EmailChangedEmailPlaceholders } from "../../types/email/email.changed.type.js";
...
const emailChangedEmail = ({
  ...
  unsubscribeUrl,
  currentYear,
}: EmailChangedEmailPlaceholders): string => {
  return `<!DOCTYPE html>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;">
      <tr>
        <td width="56" height="56" style="width:56px;height:56px;border-radius:16px;background-color:#E2F4FC;text-align:center;vertical-align:middle;" bgcolor="#E2F4FC">
          <div style="font-size:0;line-height:0;"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#0EA5E9" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M4 6.5h16v11H4z"/><path d="M4.5 7l7.5 6 7.5-6"/></svg></div>
        </td>
      </tr>
    </table>
            ...
            <p style="margin:0 0 14px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;color:#475569;">Hi ${userName}, the email address on your ${companyName} account was changed from ${oldEmail} to ${newEmail}.</p>
      ...
      <tr>
        <td style="border-radius:10px;background-color:#0EA5E9;" bgcolor="#0EA5E9">
          <a href="${verificationUrl}" target="_blank"
            ...
            <p style="margin:20px 0 0 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13px;line-height:20px;color:#94A3B8;">If you didn't make this change, contact ${supportEmail} immediately.</p>
