import type { VerifyEmailEmailPlaceholders } from "../../types/email/verify.email.type.js";
...
const verifyEmailEmail = ({
  ...
  unsubscribeUrl,
  currentYear,
}: VerifyEmailEmailPlaceholders): string => {
  return `<!DOCTYPE html>
...
<body style="margin:0;padding:0;background-color:#F1F5F9;">
  <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;font-size:1px;line-height:1px;color:#F1F5F9;">
    One click to verify your email and finish setting up your account.
  ...
  <center style="width:100%;background-color:#F1F5F9;">
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;">
      <tr>
        <td width="56" height="56" style="width:56px;height:56px;border-radius:16px;background-color:#EAE9FC;text-align:center;vertical-align:middle;" bgcolor="#EAE9FC">
          <div style="font-size:0;line-height:0;"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#4F46E5" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M4 6.5h16v11H4z"/><path d="M4.5 7l7.5 6 7.5-6"/></svg></div>
        </td>
      </tr>
    </table>
            ...
            <p style="margin:0 0 14px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;color:#475569;">Hi ${userName}, thanks for signing up. Please confirm this is your email address to activate your ${companyName} account.</p>
    ...
    <p style="margin:16px 0 0 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13px;line-height:20px;color:#94A3B8;">
      ...
      <span style="color:#475569;word-break:break-all;">${verificationUrl}</span>
    </p>
            <p style="margin:20px 0 0 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13px;line-height:20px;color:#94A3B8;">This link expires in ${expiryMinutes} minutes. If you didn't create an account, you can safely ignore this email.</p>
