import type { AnnouncementEmailPlaceholders } from "../../types/email/announcement.type.js";
...
const announcementEmail = ({
  ...
  unsubscribeUrl,
  currentYear,
}: AnnouncementEmailPlaceholders): string => {
  return `<!DOCTYPE html>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;">
      <tr>
        <td width="56" height="56" style="width:56px;height:56px;border-radius:16px;background-color:#EAE9FC;text-align:center;vertical-align:middle;" bgcolor="#EAE9FC">
          <div style="font-size:0;line-height:0;"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#4F46E5" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M3 10v4h3l7.5 4.2V5.8L6 10H3z"/><path d="M14.5 9a3.2 3.2 0 010 6"/></svg></div>
        </td>
      </tr>
    </table>
            ...
            <p style="margin:0 0 14px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;color:#475569;">Hi ${userName}, ${announcementBody}</p>
