import type { PasswordResetEmailPlaceholders } from "../../types/email/password.reset.type.js";
...
const passwordResetEmail = ({
  ...
  unsubscribeUrl,
  currentYear,
}: PasswordResetEmailPlaceholders): string => {
  return `<!DOCTYPE html>
...
<body style="margin:0;padding:0;background-color:#F1F5F9;">
  ...
  <center style="width:100%;background-color:#F1F5F9;">
      ...
      <tr>
        <td width="56" height="56" style="width:56px;height:56px;border-radius:16px;background-color:#EAE9FC;text-align:center;vertical-align:middle;" bgcolor="#EAE9FC">
          <div style="font-size:0;line-height:0;"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#4F46E5" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><circle cx="8" cy="15" r="4"/><path d="M11 12l9-9"/><path d="M17 6l3 3"/><path d="M14 9l2 2"/></svg></div>
            ...
            <p style="margin:0 0 14px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;color:#475569;">Hi ${userName}, we received a request to reset the password for your ${companyName} account. Click below to choose a new one.</p>
      ...
      <tr>
        <td style="background-color:#EDECFC;border-left:3px solid #4F46E5;border-radius:8px;padding:14px 18px;">
          <table role="presentation" cellpadding="0" cellspacing="0">
            <tr>
              <td style="vertical-align:top;padding-right:10px;padding-top:1px;"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#4F46E5" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="9"/><path d="M12 7.2V12l3.2 2.4"/></svg></td>
              <td style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13.5px;line-height:20px;color:#0F172A;">This link expires in ${expiryMinutes} minutes and can only be used once.</td>
            </tr>
          </table>
        </td>
      </tr>
    ...
    <p style="margin:16px 0 0 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13px;line-height:20px;color:#94A3B8;">
      Or copy and paste this link into your browser:<br>
      <span style="color:#475569;word-break:break-all;">${resetUrl}</span>
    </p>
            <p style="margin:20px 0 0 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13px;line-height:20px;color:#94A3B8;">If you didn't request a password reset, you can safely ignore this email — your password won't change.</p>
