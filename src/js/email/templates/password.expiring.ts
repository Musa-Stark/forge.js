import type { PasswordExpiringEmailPlaceholders } from "../../types/email/password.expiring.type.js";

const passwordExpiringEmail = ({
  daysRemaining,
  companyUrl,
  companyName,
  userName,
  ...
  unsubscribeUrl,
  currentYear,
}: PasswordExpiringEmailPlaceholders): string => {
  return `<!DOCTYPE html>
...
<title>Your password expires in ${daysRemaining} days</title>
<!--[if mso]>
<noscript>
<xml>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;">
      <tr>
        <td width="56" height="56" style="width:56px;height:56px;border-radius:16px;background-color:#FAEFE1;text-align:center;vertical-align:middle;" bgcolor="#FAEFE1">
          <div style="font-size:0;line-height:0;"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#D97706" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><circle cx="8" cy="15" r="4"/><path d="M11 12l9-9"/><path d="M17 6l3 3"/><path d="M14 9l2 2"/></svg></div>
        </td>
      </tr>
    </table>
            ...
            <p style="margin:0 0 14px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;color:#475569;">Hi ${userName}, your ${companyName} password expires on ${expiryDate} (${daysRemaining} days left). Update it now to avoid losing access.</p>
...
export default passwordExpiringEmail;
