import type { ApiKeyRevokedEmailPlaceholders } from "../../types/email/api.key.revoked.type.js";

const apiKeyRevokedEmail = ({
  apiKeyName,
  companyUrl,
  companyName,
  userName,
  ...
  unsubscribeUrl,
  currentYear,
}: ApiKeyRevokedEmailPlaceholders): string => {
  return `<!DOCTYPE html>
...
<title>API key revoked — ${apiKeyName}</title>
<!--[if mso]>
<noscript>
<xml>
...
<body style="margin:0;padding:0;background-color:#F1F5F9;">
  <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;font-size:1px;line-height:1px;color:#F1F5F9;">
    An API key on your account was revoked.
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;">
      <tr>
        <td width="56" height="56" style="width:56px;height:56px;border-radius:16px;background-color:#FBE5E5;text-align:center;vertical-align:middle;" bgcolor="#FBE5E5">
          <div style="font-size:0;line-height:0;"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#DC2626" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><circle cx="8" cy="15" r="4"/><path d="M11 12l9-9"/><path d="M17 6l3 3"/><path d="M14 9l2 2"/></svg></div>
        </td>
      </tr>
    </table>
            ...
            <p style="margin:0 0 14px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;color:#475569;">Hi ${userName}, the API key <strong>${apiKeyName}</strong> (${apiKeyPrefix}) was revoked by ${revokedBy} on ${changeDate}.</p>
        ...
        <td style="background-color:#FCE9E9;border-left:3px solid #DC2626;border-radius:8px;padding:14px 18px;">
          <table role="presentation" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13.5px;line-height:20px;color:#0F172A;">Any integrations using this key will stop working immediately. Generate a new key if you still need access.</td>
            </tr>
          </table>
        </td>
      </tr>
