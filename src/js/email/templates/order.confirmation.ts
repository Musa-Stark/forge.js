import type { OrderConfirmationEmailPlaceholders } from "../../types/email/order.confirmation.type.js";
...
const orderConfirmationEmail = ({
  ...
  unsubscribeUrl,
  currentYear,
}: OrderConfirmationEmailPlaceholders): string => {
  return `<!DOCTYPE html>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;">
      <tr>
        <td width="56" height="56" style="width:56px;height:56px;border-radius:16px;background-color:#F2E7FC;text-align:center;vertical-align:middle;" bgcolor="#F2E7FC">
          <div style="font-size:0;line-height:0;"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#9333EA" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M3.5 8l8.5-4.6L20.5 8 12 12.6 3.5 8z"/><path d="M3.5 8v9L12 21.5 20.5 17V8"/><path d="M12 12.6V21.5"/></svg></div>
        </td>
      </tr>
    </table>
            ...
            <p style="margin:0 0 14px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;color:#475569;">Hi ${userName}, thanks for your order! We've received it and we're getting it ready.</p>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin:24px 0;">
      <tr>
        <td style="background-color:#F8FAFC;border:1px solid #E2E8F0;border-radius:12px;padding:4px 20px;">
          ...
          <tr>
            <td style="padding:12px 0;border-top:1px solid #E2E8F0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:14px;color:#94A3B8;" width="42%">Order date</td>
            <td style="padding:12px 0;border-top:1px solid #E2E8F0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:14px;color:#0F172A;font-weight:600;text-align:right;">${orderDate}</td>
          </tr>
          <tr>
            <td style="padding:12px 0;border-top:1px solid #E2E8F0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:14px;color:#94A3B8;" width="42%">Total</td>
            <td style="padding:12px 0;border-top:1px solid #E2E8F0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:14px;color:#0F172A;font-weight:600;text-align:right;">${orderTotal}</td>
          </tr>
          </table>
        </td>
      </tr>
